...
@Component({
  selector: 'app-the-matrix',
  templateUrl: 'the-matrix.html',
  styleUrls: ['./the-matrix.scss']
})

export class TheMatrixComponent implements AfterViewInit {
  ...
  private handleClick() {
    ...
    if ( this.onDownPosition.distanceTo( this.onUpPosition ) === 0 ) {
      const intersects = this.getIntersects( this.onUpPosition, this.theArchitect.objects );
